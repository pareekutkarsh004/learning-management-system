...
import MyCourse from './components/pages/educator/MyCourse'; // Ensure this component exists
import student-enrolled from './components/pages/educator/studentsEnrolled'; // Ensure this component exists
