...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log("backendUrl:", backendUrl); // Fixed typo
      ...
      if (error.response) {
        ...
        switch (status) {
          ...
          case 403:
            errorMessage =
              "You are not authorized as an educator. Please contact support.";
            break;
          case 404:
            errorMessage =
              "Dashboard endpoint not found. Please check your configuration.";
            break;
          case 500:
  ...
  useEffect(() => {
    ...
    // Only fetch if we have the required context values
    if (backendUrl && isEducator !== null) {
      fetchDashboardData();
    } else {
      console.log("Waiting for context values...", { backendUrl, isEducator });
    }
  }, [isEducator, backendUrl, getToken]); // Added getToken as dependency
        ...
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="text-sm text-gray-500">
              ...
              <p>Is Educator: {String(isEducator)}</p>
            </div>
          </div>
        </div>
      </div>
