...
function CDetails() {
  ...
  // Auto-check if user is already enrolled
  useEffect(() => {
    if (course && user && course.enrolledStudents.includes(user._id)) {
      setIsEnrolled(true);
    }
  }, [course, user]);
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden min-w-[300px] sm:min-w-[420px]">
        ...
        <div className="flex justify-between items-center gap-3 px-5 pb-6 text-sm text-gray-700">
          ...
          {/* Total Lectures */}
          <div className="flex items-center gap-1">
            <img src={assets.lesson_icon} alt="clock icon" className="w-4 h-4" />
