...
function CDetails() {
  ...
  const enrollCourse = async () => {
    try {
      ...
      if (isEnrolled) return toast.warn('Already Enrolled');
      ...
      toast.error(error.message || "Enrollment error");
    }
  };
      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 flex-grow">
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="py-20 text-sm md:text-default">
            ...
            <p className="pt-3 rich-text" dangerouslySetInnerHTML={{ __html: course.courseDescription || '' }}></p>
          </div>
        </div>
