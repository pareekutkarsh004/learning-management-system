  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>
        Join our community of learners and educators. Explore a wide range of courses, from programming to art, and take your skills <brto the next level. Sign up today and start your learning journey with us!
      </p>
