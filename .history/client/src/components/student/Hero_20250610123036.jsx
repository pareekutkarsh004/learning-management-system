...
function Hero() {
  return (
    <div className='flex flex-col items-center justify-center w-full min-h-screen py-16 md:py-36 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70 to-white'>
