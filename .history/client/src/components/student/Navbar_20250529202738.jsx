...
// import assets from 'assets/assets'; // if it's default export
// import assets from 'assets/assets.json'; // if it's named export
import assets from '../../assets/assets.json'; // Adjust the path as necessary
