  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='text-gray-500 md:text-base mt-3'>
        Hear from our learners as they share their journey of transformation, success, and how our <br /> platform has made a difference in their lives.
      </p>
      <div className='grid grid-cols-auto md:grid-cols-2 lg:grid-cols-3 gap-4 mt-14'>
