...
function CourseCard({ course }) {
    ...
    return (
        <Link to={'/course/'+course._id} onClick={()=>scrollTo(0)}className="border rounded-lg shadow-md p-4 w-full sm:w-[300px] bg-white space-y-2 hover:shadow-lg transition">
            <img
