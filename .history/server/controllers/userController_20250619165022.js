...
import { clerk } from "../utils/clerkClient.js"; // ✅ changed here

// Get user data
export const getUserData = async (req, res) => {
  try {
    const clerkId = req.userId; // ✅ update: we will extract userId from middleware

    // Use clerk to get full user profile
